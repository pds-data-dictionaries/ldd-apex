...
are located at https://pds-data-dictionaries.github.io/ldd-apex.
...
Search for the \[ldd-apex\] update request block and click the green
"Get Started" button.
...
```
lddtool -lpsnJ PDS4_APEX_IngestLDD.xml
```
